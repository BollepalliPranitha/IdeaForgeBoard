...
function displayRecentBoards() {
  ...
  if (enteredPin === correctPin) {
    // Emit event to request recent boards
    socket.emit("recentBoards", null, (boards) => {
      // Update the UI with the recent boards
...
// Event listener for the New Board button
...
document.getElementById("recent-content").addEventListener("click", displayRecentBoards);
